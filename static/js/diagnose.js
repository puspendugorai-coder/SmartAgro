  ...
  panel.innerHTML=`
    <div class="results-content">
      ...
      <div class="result-body">
        ...
        <div style="padding:10px 14px;background:rgba(251,191,36,0.05);border:1px solid rgba(251,191,36,0.15);border-radius:8px;font-size:0.72rem;color:var(--text-3)"><i class="fas fa-circle-info" style="color:var(--amber);margin-right:4px"></i>${translate('diag_disclaimer')}</div>
      </div>
    </div>`;
